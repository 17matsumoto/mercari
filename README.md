...
## インストールとセットアップ
1. プロジェクトをクローンする :　git clone https://github.com/17matsumoto/mercari.git
...
3. 商品一覧: 商品を選択して閲覧します。
4. 商品詳細: 商品名のリンクをクリックし、商品詳細画面に遷移します。
5. 商品編集: 編集ボタンをクリックし、編集画面に遷移します。必要事項を入力し、Submitを押し編集完了です。
6. 商品登録: 一覧画面から商品追加をクリックし、商品追加画面に遷移します。必要事項を入力し、Submitを押し登録完了です。
