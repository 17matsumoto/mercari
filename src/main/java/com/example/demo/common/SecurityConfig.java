...
//		http.authorizeHttpRequests(authz -> authz.requestMatchers("/**").permitAll());
		...
		http.authorizeHttpRequests() // 認可に関する設定
				.requestMatchers("/login/toLogin", "/register/registerUser", "/register/", "/item/top", "/item/serchItem",
						"/itemDetail/showDetail","/edit","/updateItem","/category/searchMediamCategory","/category/searchSmalCategory","insert/csv")
		...
		http.formLogin() // ログインに関する設定
				...
				.defaultSuccessUrl("/item/top", true) // 第1引数:デフォルトでログイン成功時に遷移させるパス
